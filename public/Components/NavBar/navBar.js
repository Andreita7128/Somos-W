        ...
        <nav class="navbar navbar-expand-lg navbar-light first-nav">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="#">
                    <img class="logo1" src="../NavBar/images/logo-banco.png" alt="Logo de mi sitio web">
                </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link button-medium btn-active text-center text-button-link-normal" style="margin-left: 10px;"
        ...
        <nav class="navbar navbar-expand-lg navbar-dark  second-nav">
            <div class="container-fluid mx-auto ">
                <a class="navbar-brand d-md-none" href="#">
                    <img class="logo" src="../NavBar/images/logo-banco.png" alt="Logo de mi sitio web">
                </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav2">
                <form id="search-2" class="d-md-none d-flex mx-auto my-2 my-lg-0">
                    ...
                    placeholder="¿Que estas buscando?" aria-label="Search">
                <button class="btn btn-outline search-button mx-auto" type="submit"><i class="bi bi-search"></i></button>
                </form>

                <ul class="navbar-nav mx-auto">
                    <li class="nav-item d-md-none d-block">
                        <a class="nav-link button-medium btn-active text-center text-white mx-auto" style="margin-top: 5px;"
                        href="#">Mi perfil W</a>
                    </li>
                    <li class="nav-item d-md-none d-block">
                        <a class="nav-link button-medium btn-active text-center text-white mx-auto " style="margin-top: 18px;"
